...
describe('Routes to retrieve manifests', () => {
  ...
  describe('GET root route', () => {
    xit('should return a manifest-list', done => {
      request(app)
        .get('/v2')
  ...
  describe('GET /manifests/:id', () => {
    xit('should return a manifest', done => {
...
describe('Routes to create, update and delete manifests', () => {
  ...
  describe('POST /manifests', () => {
    xit('should create a new manifest', done => {
      request(app)
        .post('/v2/manifests')
        .send(manifexample)
        .expect('Content-Type', /json/)
  ...
  describe('PUT /manifests/:id', () => {
    xit('should modify an existing manifest', done => {
  ...
  describe('DELETE /manifests/:id', () => {
    xit('should delete an existing manifest', done => {
      new Manifest(manifexample).save()
      .then(doc => {
        request(app)
